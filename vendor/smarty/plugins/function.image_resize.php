...
function smarty_function_image_resize($params, &$smarty) {
    ...
    $filename = str_replace('.jpg' , '', substr($params['src'], strrpos($params['src'], '/')));
    $completeFilename = url . 'cached_images/' . $params['profile'] . $filename . '_' . $params['width'] . '_' . $params['height'] . '_cache.jpg';
    $completeFile = root . 'cached_images/' . $params['profile'] . $filename . '_' . $params['width'] . '_' . $params['height'] . '_cache.jpg';
    // Check if this is already cached
    if (file_exists($completeFile)) {
        if (isset($params['class'])) {
            return '<img src="' . $completeFilename . '" height="' . $params['height'] . '" width="' . $params['width'] . '" alt="' . $params['title'] . '" title="' . $params['title'] . '" class="' . $params['class'] . '" />';
        } else {
            return '<img src="' . $completeFilename . '" height="' . $params['height'] . '" width="' . $params['width'] . '" alt="' . $params['title'] . '" title="' . $params['title'] . '" />';
        }
    }
    ...
    if ( ($width >= $oldWidth) && ($height >= $oldHeight)) {
        return '<img src="' . $params['src'] . '" height="' . $height . '" width="' . $width . '" alt="' . $params['title'] . '" title="' . $params['title'] . '" class="' . $params['class'] . '" />';
    }
    ...
    if (isset($params['class'])) {
        return '<img src="' . $completeFilename . '" height="' . $height . '" width="' . $width . '" alt="' . $params['title'] . '" title="' . $params['title'] . '" class="' . $params['class'] . '" />';
    } else {
        return '<img src="' . $completeFilename . '" height="' . $height . '" width="' . $width . '" alt="' . $params['title'] . '" title="' . $params['title'] . '" />';
    }
}
