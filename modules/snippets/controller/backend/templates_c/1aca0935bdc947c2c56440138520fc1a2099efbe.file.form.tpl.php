<?php /* Smarty version Smarty-3.1.8, created on 2014-02-20 11:55:33
...
<?php if ($_valid && !is_callable('content_5304e8e4998931_71712041')) {function content_5304e8e4998931_71712041($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\wamp\\www\\dev\\DEBCMS\\vendor\\smarty\\plugins\\modifier.date_format.php';
                    ...
                    <script>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['page']->value!=null){?>
                            <div class="form-group">
                                ...
                                <i><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['page']->value->updated,'d-m-Y H:i');?>
</i>
                            </div>
                            <div class="form-group">
                                <label>Aangemaakt op</label>
                                <i><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['page']->value->created,'d-m-Y H:i');?>
</i>
                            </div>
                        <?php }?>
